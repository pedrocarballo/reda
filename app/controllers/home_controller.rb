...
class HomeController < ApplicationController
  def index
    ...
    @next_workshops =[
      { title: "NodeJS1.6", subtitle: "WebSockets com Express Básico", info: "", dates: "2, 4 e 6/4", status: [:notice, "Aguarde"], level: "" },
      { title: "NodeJS1.6", subtitle: "WebSockets com Express Avançado", info: "", dates: "2, 4 e 6/4", status: [:notice, "Aguarde"], level: "" },
      { title: "JaxGL", subtitle: "WebGL para programadores Rails", info: "", dates: "9, 11 e 13/4", status: [:notice, "Aguarde"], level: "" },
      { title: "Vim", subtitle: "Subtitle here!", info: "", dates: "16, 18 e 20/4", status: [:notice, "Aguarde"], level: "" }
    ].map{|w| OpenStruct.new(w) }
  end
